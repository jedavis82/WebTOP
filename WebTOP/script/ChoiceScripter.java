...
public class ChoiceScripter extends Scripter implements ItemListener
{
	...
	public ChoiceScripter(Choice c,webtop.wsl.client.WSLPlayer player,String id,String param,String[] vals,int defVal,ItemListener il) {
	...
	protected void setValue(String value) {
		if(listener!=null) {
			...
			webtop.component.WApplet.pickChoice(choice,i,listener);
		}
	}
