...
public abstract class WApplication
   ...
   public void initNavPanel() {
	   navPanel = new NavigationPanel(getSAI(),getSAI().getNode(NAV_PANEL_NAME), (short)0, "Scene Controls: Lamps change viewpoints. Bidirectional " +
	   		"arrow zooms. Multidirectional arrow pans. Sphere rotates.");
