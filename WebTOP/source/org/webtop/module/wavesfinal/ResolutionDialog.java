...
public class ResolutionDialog extends JFrame implements ActionListener {
	...
	public ResolutionDialog(WavesFinal wave, Engine e) {
		...
		resolution = new IntBox(0,400,0,3);
	...
	public void actionPerformed(ActionEvent e) {
		setVisible(false);
		if(e.getSource()==ok){
			engine.setPoolOptions(resolution.getValue(), /*gouraud.getState()*/ gouraud.isEnabled());
			setVisible(false);
		}
	}
