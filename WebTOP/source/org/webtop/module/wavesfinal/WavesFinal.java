...
public class WavesFinal extends WApplication implements ActionListener, ItemListener, 
NumberBox.Listener, ChangeListener{
	...
	public WavesFinal(String title, String world){
	...
	protected void setupGUI() {
		...
		linearOneWavelength = new FloatBox(0,50,8,4);
		...
		linearTwoWavelength = new FloatBox(0,50,8,4);
		...
		pointOneAmplitude = new FloatBox(0,10,4,4);
		pointOneAmplitude.addNumberListener(this);
		pointOneWavelength = new FloatBox(0,50,8,4);
		...
		pointTwoAmplitude = new FloatBox(0,10,4,4);
		pointTwoAmplitude.addNumberListener(this);
		pointTwoWavelength = new FloatBox(0,50,8,4);
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		WavesFinal waves = new 
		WavesFinal("WavesFinal", "/org/webtop/x3dscene/wavestest.x3dv");
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		/*if(e.getSource().equals(linearOneActive)||e.getSource().equals(linearTwoActive)||
			...
			setDefaultValues();
			engine.setPoolOptions(200, true);
			resolutionDrop.setSelectedIndex(0);
			engine.update();
		}
