...
class ObservationScreen extends OpticalElement implements X3DFieldEventListener, NumberBox.Listener,
    ...
    public ObservationScreen(Geometrical main, float position) {
    ...
    public void readableFieldChanged(X3DFieldEvent e) {
        ...
        if (mode == SIZE) {
            ...
            DebugPrinter.println("ObservationScreen: size -> {" + size[0] + "w," + size[1] + "h}");
    ...
    public void numChanged(NumberBox src, Number value) {
        ...
        if (src == fbWidth) {
            ...
            System.err.println("ObservationScreen: unexpected numChanged event from " + src + '!');
        }
    }
    ...
    public void invalidEntry(NumberBox src, Number value) {
        if (src == fbWidth) {
            ...
            System.err.println("ObservationScreen: unexpected invalidEvent from " + src);
        }
    }
    ...
    /*public WSLNode toWSLNode() {
        WSLNode node = new WSLNode("observationscreen");
