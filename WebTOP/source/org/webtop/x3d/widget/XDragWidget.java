 ...
 * @version 0.0
 */
public class XDragWidget extends ScalarWidget {
        /**
         * Event name used by the VRMLLib <code>XDragWidget</code>.
         */
        ...
        /**
         * Constructs a <code>XDragWidget</code> for the named widget.
         * <br>See next constructor for parameter details.
         */

        //////////////////////////////////////////////////////////////////////////////////////////////
        //TODO: This block was also commented out and broke wavefront, uncommented to fix temporarily
        //public XDragWidget(EAI eai,String widgetName,short widgetId,String help) {
        ...
        /*
         *
         * Constructs a <code>XDragWidget</code> for the given <code>NamedNode</code>.
         *
         * @param eai the <code>EAI</code> object through which to access the VRML browser.
         * @param widgetNode the <code>NamedNode</code> to associate with this <code>XDragWidget</code>.
         * @param widgetId an arbitrary integer to be used to identify this <code>XDragWidget</code>.
         * @param help an arbitrary String, as for a help message.
         */
        public XDragWidget(SAI sai, NamedNode widgetNode, short widgetId, String help) {
